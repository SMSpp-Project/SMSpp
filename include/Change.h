 ...
 * Block, and for the *concrete* GroupChange class, a group of Change applied
 * as a single one (the same relationship that GroupModification has with
 * Modification, see Modification.h).
 * 
